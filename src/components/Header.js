            ...
            >
                ...
                <div className="flex md:hidden ">
                    {menuItems.map((item) => {
                        return (
                            <li
                                className={`list-none mx-5 p-1 hover:text-secondary ease-in duration-100 ${item.key == pathName &&
                ...
                >
                    {menuItems.map((item) => {
                        return (
                            <li
                                className={`list-none  py-1 ${item.key == pathName && "bg-white text-black rounded-md px-5"
                                    } `}
                            >
                                <Link to={`${item.key}`}>{item.title}</Link>
                            </li>
