                ...
                <div className="h-screen bg-theme">
                    <div className="grid md:grid-cols-1 grid-cols-2 h-screen items-center">
                        ...
                        <div className="font-bold text-white md:px-5">
                            <h1 className="text-7xl md:text-4xl">Hi , I am <b className="text-yellow-500">ANISH</b></h1>
                            <h1 className="text-4xl md:text-xl">ReactJS <b className="text-red-500">Developer</b></h1>
                        </div>
                    </div>
                </div>
            </div>
